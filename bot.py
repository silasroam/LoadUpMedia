...
================================================================================
 ...
 КАК ЗАПУСТИТЬ:
   1. Вставьте токен бота из @BotFather в переменную BOT_TOKEN ниже
      (или задайте переменную окружения BOT_TOKEN — так безопаснее,
      особенно на Render).
...
#    На Render удобнее задать его через переменную окружения BOT_TOKEN,
#    чтобы токен не лежал в репозитории. Значение ниже — запасной вариант.
...
async def main() -> None:
    ...
    if "PASTE_YOUR_BOT_TOKEN_HERE" in BOT_TOKEN:
        raise SystemExit(
            "✋ Сначала вставьте токен бота в переменную BOT_TOKEN "
